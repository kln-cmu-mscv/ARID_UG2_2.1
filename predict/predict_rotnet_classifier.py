...
from data.rotnet_video_iterator import RotnetVideoIter
...
if __name__ == '__main__':
	...
	# creat model
	sym_net, input_config = get_symbol(name=args.network, pretrained=True, pretrained_path=args.pretrained_path, **dataset_cfg)
	...
	model_prefix= os.path.join(args.model_dir, "rotnet_classifier_lr_0_001")
	net = static_model(net=sym_net, criterion=criterion, model_prefix=model_prefix)
	net.load_checkpoint(epoch=args.load_epoch)

	# data iterator:
	data_root = "../dataset/{}".format("ARID")
